...
var getUserData = exports.getUserData = (0, _debouncePromise2.default)(getUserDataFn, 700);
},{"debounce-promise":15}],3:[function(require,module,exports) {
'use strict';
...
var nameChangeAction = function nameChangeAction(name) {
...
var actions = {
	updateUsername: function updateUsername(username) {
		return function (state, actions) {
			(0, _api.getUserData)(username).then(actions.setUserData);
...
},{"./api":14}],2:[function(require,module,exports) {
'use strict';
...
(0, _hyperapp.app)(state, _actions2.default, view, document.body);
},{"hyperapp":6,"./styles/style.sass":4,"./actions.js":3}],12:[function(require,module,exports) {
